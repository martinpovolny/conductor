...
describe HardwareProfile do
  ...
  it "should not return unit_price and cost_now given no cost is assigned" do
    back_end_hardware_profile1 = FactoryGirl.create(:back_hwp_ranged_cpu)
    back_end_hardware_profile1.unit_price.should be_nil
    back_end_hardware_profile1.cost_now.should be_nil
  end

  it "should return unit_price and given cost is assigned until the cost is closed" do
    back_end_hardware_profile1 = FactoryGirl.create(:back_hwp_ranged_cpu)

    cost1 = FactoryGirl.create(:cost, 
      :chargeable_id => back_end_hardware_profile1.id)

    back_end_hardware_profile1.unit_price.should_not be_nil
